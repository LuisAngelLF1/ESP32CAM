...
int led=12; //variable que controla el led externo 
...
void setup() {
  ...
  digitalWrite(led,LOW);//Se comienza con el led apagado
...
void loop() {
  ...
  digitalWrite(led, HIGH);//enciende led externo
  delay(1000);//espera un segundo
  digitalWrite(led,LOW);//apaga led externo
  delay(1000);
}// Fin de void loop
